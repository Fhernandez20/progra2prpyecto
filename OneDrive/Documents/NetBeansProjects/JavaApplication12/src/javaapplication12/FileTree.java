...
public class FileTree extends JFrame {
    ...
    public FileTree(Logic logicaArchivos) {
    ...
    private void ejecutarAccionOrdenar(String opcion) {
        ...
        if (archivosOrdenados != null) {
            ...
            System.out.println("No se pudieron ordenar los archivos.");
            actualizarArbol();
        }
    }
    ...
    private void actualizarArbol() {
        ...
        cargarDirectorios(new File("C:/"), nodoRaiz);  // Asegúrate de que "C:/" sea un directorio válido
        modeloArbol.reload();
    }
            ...
            if (archivos != null) {
                for (File archivo : archivos) {
                    ...
                    if (archivo.isDirectory()) {
                        cargarDirectorios(archivo, nuevoNodo);  // Recursión para cargar subdirectorios
                    }
                }
            }
        } else {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new FileTree(new Logic()));
    }
}